/**
 * Modifies data validation rules to allow custom entries with warnings and updates headers in all campus spreadsheets.
 * 
 * Goes into each campus file listed in CampusBMCSheetInfo column E and updates:
 * - Monthly tabs (AUGUST-MARCH): 
 *   - Updates G2 header to "List any Additional Disabilities"
 *   - Updates data validation in G3:G to "Show warning" and allow invalid data
 * - APRIL/ MAY PROJECTIONS tab: 
 *   - Updates H3 header to "List any Additional Disabilities"
 *   - Updates data validation in H4:H to "Show warning" and allow invalid data
 * 
 * This keeps the dropdown suggestions but allows users to enter custom data.
 * 
 * @returns {void}
 */
