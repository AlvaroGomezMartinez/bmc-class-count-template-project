/**
 * Removes dropdown data validation from the secondary disability column in all
 * campus spreadsheets listed in CampusBMCSheetInfo column E.
 *
 * Does NOT clear cell contents — only removes the validation rules.
 *
 * For monthly tabs (AUGUST–MARCH): clears validation from G3:G.
 * For the APRIL/MAY PROJECTIONS tab: clears validation from H4:H.
 *
